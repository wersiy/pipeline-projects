...
rm .bash_profile
wget https://raw.githubusercontent.com/wersiy/pipeline-projects/jenkins-master-client-config/.bash_profile
source .bash_profile
mvn -v
...
wget https://raw.githubusercontent.com/wersiy/pipeline-projects/jenkins-maven-sonarqube-nexus/settings.xml -P /var/lib/jenkins/.m2/
